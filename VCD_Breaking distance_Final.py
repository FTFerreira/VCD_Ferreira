...
#Compute distance of stop using the equilibrium of work because all kinetic will be transformed in friction (kinetic energy = friction energy)
Sstop = (v0**2)/(2*9.81*(fcoef*np.cos(thetarad)+np.sin(thetarad)))

#Compute the time needed to stop using the equation of motion (moment the car stops (a=0))
Tstop = Sstop/v0

#Compute de-acceleration according to the initial speed and the time needed to stop
a = v0/Tstop
